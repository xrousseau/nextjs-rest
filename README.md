...
You will need to set up a content model within your Contentful space. For this project, we need a `Article` content type with the following fields:

- `slug`
- `title`
- `introduction`

Once you've set up the `Article` content model, you can populate it with some example entries.
